...
from cotracker import CotrackerLightNew, DAVIS_Video, CoEvaler, VideoLoss
import os
import logging
...
model_name = "cotracker_light_new_after_you"
pretrain_model_path = "model/cotracker_light_new_you_best.pth"
frame_num = 6
point_num = 16
