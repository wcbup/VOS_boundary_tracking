...
from cotracker import Cotracker, CoEvaler, VideoLoss
import os
import logging
from Loader_17 import DAVIS_Rawset, DAVIS_Aug_Dataset, DAVIS_Aug_Rawset
from deform_video import DAVIS_withPoint
import json

model_name = "cotracker_aug"
frame_num = 10
...
train_video_set = DAVIS_Aug_Dataset(train_raw_set.data_set, 32, frame_num, False)
...
logging.info(f"Val dataset length: {len(val_point_set)}")
